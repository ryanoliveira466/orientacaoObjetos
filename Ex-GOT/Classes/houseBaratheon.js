...
exports.houseBaratheon = void 0;
var NobleHouse_1 = require("./NobleHouse");
var houseBaratheon = /** @class */ (function (_super) {
    __extends(houseBaratheon, _super);
    function houseBaratheon(houseName, houseAnthem, houseFamilyNumber, houseMoney) {
    ...
    houseBaratheon.prototype.houseTalk = function () {
        console.log("The family is talking");
    };
    houseBaratheon.prototype.getFamilyNumber = function () {
        return this.houseFamilyNumber;
    };
    return houseBaratheon;
}(NobleHouse_1.NobleHouse));
exports.houseBaratheon = houseBaratheon;
